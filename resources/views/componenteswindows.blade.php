...
<body>
    ...
    <section style="top: 16vh; position: relative;">
        ...
        <div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-1" style="display:flex;align-items:center;justify-content:center;"><a href="/funcionalidaddewindows"><div class="anterior"></div></a></div>
                    ...
                    <div class="col-1" style="display:flex;align-items:center;justify-content:center;"><a href="/usuariowindows"><div class="siguiente"></div></a></div>
                </div>
            </div>
        </div>
    </section>
